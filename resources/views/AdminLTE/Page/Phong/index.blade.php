                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button id="delete_accpect" type="button" class="btn btn-primary"
                                            data-dismiss="modal">Chấp Nhận Xóa</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            function showTable(list_phong) {
                ...
                $.each(list_phong, function(key, value) {
                    ...
                    noi_dung += '<button data-id="' + value.id +
                        '" data-hangngang="'+ value.hang_ngang +'" data-hangdoc="'+ value.hang_doc +'" class="ghe btn btn-primary mr-1" data-toggle="modal" data-target="#gheModal">Xem Ghế</button>';
                    noi_dung += '<button data-id="' + value.id +
                        '" class="edit btn btn-info mr-1" data-toggle="modal" data-target="#editModal">Cập Nhật</button>';
                    noi_dung += '<button data-id="' + value.id +
                        '" class="del btn btn-danger" data-toggle="modal" data-target="#deleteModal">Xóa Phòng</button>';
                    noi_dung += '</td>';
                    noi_dung += '</tr>';
                });
